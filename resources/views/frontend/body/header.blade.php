      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            @if(session()->get('language') == 'hindi') मेरी प्रोफाइल @else My Account @endif </a></li>
            ...
            @if(session()->get('language') == 'hindi') मेरी गाड़ी @else My Cart @endif </a></li>
        ...
        <div class="cnt-block">
          <ul class="list-unstyled list-inline">
            ...
            @if(session()->get('language') == 'hindi') भाषा:हिन्दी @else Language @endif </span><b class="caret"></b></a>
              <ul class="dropdown-menu">
           ...
           @foreach( $subcategories as $subcategory)
              ...
              <h2 class="title"> 
               ...
               @php
                ...
                <ul class="links">
                  <li>
        <a href="#">  @if(session()->get('language') == 'hindi') {{ $subsubcategory->subsubcategory_name_hin }} @else {{ $subsubcategory->subsubcategory_name_en }}  @endif</a>
                  </li>
