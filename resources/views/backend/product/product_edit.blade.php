    ...
    <input type="text" name="product_name_en" class="form-control" required="" value="{{ $products->product_name_en	}}">
       ...
       <div class="col-md-4"> 
           <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" name="product_name_hin" value="{{ $products->product_name_hin }}" class="form-control" required="">
    ...
    <div class="row">  <!-- start fourth row -->
       ...
       <div class="col-md-4"> <!-- col-md-4 -->
          <div class="form-group">
                ...
                <div class="controls">
                   <input type="text" name="product_tags_hin" value="{{ $products->product_tags_hin }}" class="form-control"  data-role="tagsinput"  required=""> 
       ...
       <div class="col-md-4"> 
           <div class="form-group">
               ...
               <div class="controls">
                  <input type="text" name="product_size_en" value="{{ $products->product_size_en }}" class="form-control" value="small,medium,large" data-role="tagsinput"  required=""> 
       ...
       <div class="col-md-4">
          <div class="form-group">
               ...
               <div class="controls">
                  <input type="text" name="product_size_hin" value="{{ $products->product_size_hin }}"  class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput"  required=""> 
    ...
    <div class="row">  <!-- start five row -->
       ...
       <div class="col-md-6"> 
           <div class="form-group">
               ...
               <div class="controls">
                  <input type="text" name="product_color_hin" value="{{ $products->product_color_hin }}"  class="form-control" value="small,medium,large" data-role="tagsinput" required=""> 
  ...
  <div class="row">  <!-- start seven row -->
    ...
    <div class="col-md-6"> 
        <div class="form-group">
           ...
           <div class="controls">
              <textarea name="short_descp_hin" id="textarea" class="form-control" required placeholder="Textarea text"  required="">
