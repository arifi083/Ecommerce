    ...
    <div class="row">  <!-- start fourth row -->
       ...
       <div class="col-md-4">
          <div class="form-group">
               ...
               <div class="controls">
                  <input type="text" name="product_size_hin" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput"  required=""> 
    ...
    <div class="row">  <!-- start five row -->
       ...
       <div class="col-md-4"> 
           <div class="form-group">
               ...
               <div class="controls">
                  <input type="text" name="product_color_hin" class="form-control" value="small,medium,large" data-role="tagsinput" required=""> 
